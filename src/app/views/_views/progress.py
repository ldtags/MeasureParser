...
from src.app.widgets import Page, Frame, ScrollableFrame, Button
...
class ProgressView(Page):
    ...
    def __init__(self, parent: tk.Misc, root: tk.Tk, **kwargs):
        ...
        self.log_frame = ScrollableFrame(self, canvas_bg="#ffffff", scrollbar=True)
        self.log_frame.pack(
            side=tk.TOP,
            anchor=tk.NW,
            fill=tk.BOTH,
...
class ControlsFrame(Frame):
    def __init__(self, parent: Frame, **kwargs):
        ...
        self.cont_btn = Button(self, pady=0, padx=25, text="Continue", state="disabled")
        self.cont_btn.pack(side=tk.RIGHT, anchor=tk.E, padx=(15, 30), pady=(20, 20))

        self.back_btn = Button(self, pady=0, padx=25, text="Back")
        self.back_btn.pack(side=tk.RIGHT, anchor=tk.E, padx=(30, 15), pady=(20, 20))
